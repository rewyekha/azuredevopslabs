...
1. Once you run the application choose **SonarQube** template, choose the right authentication method.
...
1. Create a project with **Name** and **Key** as **MyShuttle**. Provide **Main branch name** as master. Then click on **Create**
   ...
   - **Main branch name**: Name of the major branch of the repository. This in some cases will be _main_ and in some cases _master_
...
The link will open the **MyShuttle** project in the SonarQube Dashboard. Under **_Bugs and Vulnerabilities_**, we can see that there are 4 bugs reported.
