...
1. Once you run the application choose **Python** template, choose the right authentication method.
...
In this exercise, you will examine the source code provisioned by above created project.

1. Navigate to the project you created above using **Python** template from Azure DevOps Demo Generator.
