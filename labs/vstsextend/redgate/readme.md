...
1. You will need an Azure DevOps Organization. If you do not have one, you can sign up for free [here](https://azure.microsoft.com/en-us/services/devops/)
...
1. Repeat the same steps for **pul-prod** database.
