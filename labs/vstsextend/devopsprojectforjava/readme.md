...
The Azure DevOps Project simplifies the initial configuration of a continuous integration (CI) and continuous delivery (CD) pipeline for your Java app in Azure DevOps (Azure DevOps).

## What's covered in this lab?

In this lab, you will

- create new Azure DevOps Organization with Java project sample using **Azure DevOps Project** feature in Azure
...
6. You can create a free **new Azure DevOps** account or use an **existing account**. In this lab let us create **new Azure DevOps Organization**. Choose a name for your Azure DevOps **account** and **project**. Select your **Azure subscription**, **location**, and choose a **name** for your application. When you're done, choose **Done**.

   ![vstsproject](images/vstsproject.png)

7. In a few minutes, the **project dashboard** loads in the Azure portal. A sample java application is set up in a repository in your Azure DevOps Organization, a build executes, and your application deploys to Azure. This dashboard provides visibility into your **code repository**, **Azure DevOps CI/CD pipeline**, and your **application in Azure**.
...
## Exercise 2: Examine the Azure DevOps CI/CD pipelines configured by Azure DevOps Project
...
4. Under your build definition name, select **History**. You see an audit trail of your recent changes for the build. Azure DevOps keeps track of any changes made to the build definition, and allows you to compare versions.
...
7. Select **Build and Release**, then choose **Releases**. The Azure DevOps project created a Azure DevOps release definition to manage deployments to Azure.
...
13. Select the **ellipsis** next to one of your releases, and choose **Open**. There are several menus to explore from this view such as a release summary, associated work items, and tests.
...
5. In your browser, navigate to the **Builds**. You should now see a build is in progress. The changes you just made are automatically built and deployed via a Azure DevOps CI/CD pipeline.
