...
- An Azure DevOps Organization from <https://dev.azure.com>

- ARM Outputs extension installed in your Azure DevOps Organization from
...
1.  Enter the settings below. You can use the browse navigation to
    ...
    **\$(System.DefaultWorkingDirectory)/\_ContosoAir-CI/drop/Templates/azuredeploy.parameters.json**
    ...
    something like **-p_environment johndoe**. This will be used as
