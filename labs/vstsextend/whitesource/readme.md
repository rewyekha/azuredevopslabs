...
1. Once you run the application choose **WhiteSource-Bolt** template, choose the right authentication method.
...
With Azure DevOps and Mend Bolt integration, you can _shift-left_ your open source management. The integration allows you to have alerts in real time, on vulnerabilities and other issues to help you take immediate action.
